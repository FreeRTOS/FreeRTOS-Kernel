...
RP2040_CONFIG_DIR="$SOURCE_DIR/portable/ThirdParty/GCC/RP2040/include"
...
-I $PICO_SDK_DIR/src/rp2_common/cmsis/include \
...
-I $PICO_SDK_DIR/src/rp2_common/pico_stdio_usb/include \
